...
contract G1MSMTest is PrecompileTestBase {
    function test_g1Msm_validVectors() public {
        string memory path = "test/vectors/msm_G1_bls.json";
    ...
    function test_g1Msm_internal_validVectors() public {
        string memory path = "test/vectors/msm_G1_bls.json";
        string memory json = vm.readFile(path);
    ...
    function test_g1Msm_invalidVectors() public {
        vm.pauseGasMetering();
        string memory path = "test/vectors/fail-msm_G1_bls.json";
        string memory json = vm.readFile(path);
